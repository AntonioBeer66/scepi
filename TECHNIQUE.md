...
- Chaque joueur dispose de 30 secondes pour jouer une carte ; à expiration, le serveur choisit au hasard une carte autorisée. Le serveur contrôle le délai et empêche qu'une action tardive joue une seconde carte.
